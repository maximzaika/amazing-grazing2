...
<html lang="en">
	...
	<body>			
			...
			<div class="row">
				<div class="col-md-12 pull-left">
					<h5 class="breadcrumbs">
						...
						<span><u><i>Rotational</i> <i class="ion-ios-arrow-forward"></u></i></a>
					</h5> 
					<hr>
				</div>
			</div>
		...
		<!-- Section 2: Header of the Rotational Grazing -->
		<?php echo htmlspecialchars_decode(retrieveTechniques($con, "ROTATIONAL GRAZING"));?>
		<!-- End Section 2: Header of the Rotational Grazing -->
