							...
							<div class="text p-4 float-right d-block">
								<div class="topper d-flex align-items-center">
									...
									<div class="two pl-0 pr-3 py-2 align-self-stretch">
										<span class="yr">YYYY</span>
										<span class="mos">Month</span>
									</div>
								</div>
								
								<h3 class="heading mb-0"><a href="#">Grazing News Title 1</a></h3>
								<p>Grazing isdangerous. It is really dangerous. Themost dangerous thing about grazing is grazing. Actually terrible.</p>
					...
					<div class="col-md-4 d-flex ftco-animate">
						<div class="blog-entry justify-content-end">
							...
							<div class="text p-4 float-right d-block">
								...
								<h3 class="heading mb-0"><a href="#">Grazing News Title 2</a></h3>
								<p>Grazing isdangerous. It is really dangerous. Themost dangerous thing about grazing is grazing. Actually terrible.</p>
								<p><a href="#" class="btn btn-primary">Read more</a></p>
							</div>
						</div>
					...
					<div class="col-md-4 d-flex ftco-animate">
						<div class="blog-entry justify-content-end">
							...
							<div class="text p-4 float-right d-block">
								...
								<h3 class="heading mb-0"><a href="#">Grazing News Title 3</a></h3>
								<p>Grazing isdangerous. It is really dangerous. Themost dangerous thing about grazing is grazing. Actually terrible.</p>
								<p><a href="#" class="btn btn-primary">Read more</a></p>
							</div>
						</div>
