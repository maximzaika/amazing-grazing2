		...
		<section class="ftco-section ftco-no-pt ftco-no-pb bg-light">
			<div class="container-fluid">
				<div class="row justify-content-center mb-5">
					<div class="col-xxs-12 col-xs-12 col-sm-12 col-md-12 col-lg-6 py-5 heading-section coftco-animate">
						<h2 class="mb-4 text-center" style=" color: #228B22;">title title title title</h2>
						
						<div class="row">
							<div class="col-xxs-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 mobile-left" style="margin:auto;">
								<img src="images/continuous-grazing.gif" class="animated-gif" style="border-radius:40px;">
							</div>
							
							<div class="col-xxs-12 col-sx-12 col-sm-12 col-md-6 col-lg-6" style="margin:auto;">
									...
									<li class="service-techniques services-color">
										<div class="container">
											<div class="row">
												...
												<div class="col-xxs-8 col-xs-8 col-sm-11 col-md-10 col-lg-10" style="margin: auto;">
													<h5>text text text text text text text text text text text </h5>
												</div>
											</div>
										</div>
									</li>
