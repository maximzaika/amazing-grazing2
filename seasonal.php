  ...
  <body>
	...
	<section class="ftco-section ftco-no-pt ftco-no-pb">
		<div class="container">
			<div class="row justify-content-center mb-5">
				<div class="col-md-10 py-5 text-center heading-section ftco-animate">
					<a href="download/seasonal_grazing_brochure.pdf" class="btn btn-primary" style="margin: 10px;">View the Brochure</a>
					<a href="download/seasonal_grazing_brochure.pdf" class="btn btn-primary" style="margin: 10px;" download>Downlaod the Brochure</a>
				</div>
			</div>
		</div>
	</section>
