<?php
	...
	*/
	...
	echo json_encode(array("selected_beef_qty"=>$selected_beef_qty, 
						   ...
						   "preview_beef"=>$preview_beef,
						   "modal_beef_title"=>$modal_beef_title,
						   "modal_beef_text"=>$modal_beef_text,
						   "preview_dairy"=>$preview_dairy,
						   "modal_dairy_title"=>$modal_dairy_title,
						   "modal_dairy_text"=>$modal_dairy_text,
						   "preview_milk"=>$preview_milk,
						   "modal_milk_title"=>$modal_milk_title,
						   "modal_milk_text"=>$modal_milk_text,
						   "preview_sheep"=>$preview_sheep,
						   "modal_sheep_title"=>$modal_sheep_title,
						   "modal_sheep_text"=>$modal_sheep_text,
						   "preview_wool"=>$preview_wool,
						   "modal_wool_title"=>$modal_wool_title,
						   "modal_wool_text"=>$modal_wool_text,
						   "preview_land"=>$preview_land,
						   "modal_land_title"=>$modal_land_title,
						   "modal_land_text"=>$modal_land_text,
						   "preview_meat"=>$preview_meat,
						   "modal_meat_title"=>$modal_meat_title,
						   "modal_meat_text"=>$modal_meat_text,
						   "preview_yarn"=>$preview_yarn,
						   "modal_yarn_title"=>$modal_yarn_title,
						   "modal_yarn_text"=>$modal_yarn_text,
						   "preview_total"=>$preview_total,
						   "modal_total_title"=>$modal_total_title,
						   "modal_total_text"=>$modal_total_text)); /* Encode back into the json and send to the javascript, which will push the data to the HTML */
