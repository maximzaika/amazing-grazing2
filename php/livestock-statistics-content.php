<?php   
     ...
     *
	 * Description::
	 *  - 1) updates spinner content retrieved from the DB
	 *  - 2) retrieves the right side of the spinner (introduction content)
     *
	 * Attributes:
	 *  - none
	 *
	 ...
	 *
	 * Return:
	 *  - $spinner_content & $live_intro can be requested by the client (livestock-statistics.php)
	*/
